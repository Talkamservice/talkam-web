...
export const SubCategoryCard = ({ name, followercount, id }) => {
    return (
        <Link to={`/category/${id}`} className="w-full flex flex-col gap-2 border border-[#E0F1FE] bg-[#F0F9FF] px-3 py-3 rounded-md cursor-pointer">
