...
export const PostActionButton = ({ count, handleReaction, reaction }) => {
    ...
    return (
        ...
        <Button
            ...
            leftIcon={
                <AuthWrapper onClick={() => handleReaction("Like")} size={20}>
                    <Icon.ThumbsUp
                        fill={reaction === "Like" ? "#017FC8" : "#FFFFFF"}
                    />
                </AuthWrapper>
            }
            rightIcon={
                <AuthWrapper onClick={() => handleReaction("Dislike")} size={20}>
                    <Icon.ThumbsDown
                        fill={reaction === "Dislike" ? "#FF0000" : "#FFFFFF"}
                    />
                </AuthWrapper>
            }
        />
