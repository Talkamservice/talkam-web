...
export const WaitlistPage = () => {
  ...
  return (
    ...
    <>
      <Helmet>
        <title>Join the Waitlist - TalkAM</title>
        <meta charset="utf-8" />
        <meta name="description" content="Join TalkAM's waitlist and get early access to our platform. Stay updated with the latest news and features." />
        <meta name="keywords" content="TalkAM, waitlist, early access, anonymous chat" />
        <meta name="author" content="TalkAM" />
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        <meta name="csrf_token" content="" />
        <meta property="type" content="website" />
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
        <meta property="image" content={logo} data-react-helmet="true" />
        <meta content="image/*" property="og:image:type" data-react-helmet="true" />
        <meta property="og:title" content="Join the Waitlist - TalkAM" />
        <meta property="og:description" content="Join TalkAM's waitlist and be the first to access our platform." />
        <meta property="og:image" content={logo} />
        <meta property="og:url" content="https://https://waitlist.talkam.net/" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Join the Waitlist - TalkAM" />
        <meta name="twitter:description" content="Sign up for TalkAM's waitlist and get early access." />
