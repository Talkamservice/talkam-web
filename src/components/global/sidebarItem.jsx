...
export const SideBarItem = ({ children, url, icon, image, onClick }) => {
    ...
    return (
        <NavLink onClick={onClick} to={url} className={`cursor-pointer hover:bg-tgray-xlight rounded-md p-2 w-full flex items-center justify-start leading-none no-underline hover:no-underline m-0 `}
            style={({ isActive }) => {
                return {
