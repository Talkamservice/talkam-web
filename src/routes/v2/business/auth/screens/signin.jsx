      ...
      <form className="flex flex-col gap-4" onSubmit={(e) => { e.preventDefault(); submit(null); }}>
        ...
        <div className="flex flex-col gap-2 sm:flex-row">
          <button
            ...
            disabled={isLoading}
            className="py-4 sm:h-12 sm:py-0 flex-1 cursor-pointer rounded-ds-md bg-navy-800 text-[13.5px] font-extraboldNunito text-white transition-colors hover:bg-navy-900 disabled:cursor-not-allowed disabled:opacity-70"
          >
            {pendingRole === "admin" ? "Signing in…" : "Admin"}
          </button>
          <button
            type="button"
            onClick={() => submit("employee")}
            disabled={isLoading}
            className="py-4 sm:h-12 sm:py-0 flex-1 cursor-pointer rounded-ds-md bg-brand-400 text-[13.5px] font-extraboldNunito text-white transition-colors hover:bg-brand-600 disabled:cursor-not-allowed disabled:opacity-70"
          >
            {pendingRole === "employee" ? "Signing in…" : "Employee"}
          </button>
          <button
            type="button"
            onClick={() => submit("therapist")}
            disabled={isLoading}
            className="py-4 sm:h-12 sm:py-0 flex-1 cursor-pointer rounded-ds-md bg-wellness-400 text-[13.5px] font-extraboldNunito text-white transition-colors hover:bg-wellness-600 disabled:cursor-not-allowed disabled:opacity-70"
          >
            {pendingRole === "therapist" ? "Signing in…" : "Therapist"}
          </button>
        </div>
      </form>
