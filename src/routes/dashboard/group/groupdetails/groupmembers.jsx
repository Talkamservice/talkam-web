...
export const GroupMembers = ({ currentUserRole }) => {

    const { groupId } = useParams();
    const { data:groupMembers, isLoading } = useGetGroupMembersQuery(groupId);
...
const MemberListCard = ({ avatar, user, role, currentUserRole, joined, poppostion, handleDeleteMember, handleMakeModerator, handleRemoveModerator, userId }) => {
