...
export const GroupTrending = () => {
    ...
    const handleScroll = useCallback((event) => {
        ...
        Storage.setItem("scrollPosition_grouptrending", scrollTop);
    }, [isFetching, trending]);

    const restoreScrollPosition = () => {
        const savedScrollPosition = Storage.getItem("scrollPosition_grouptrending");
