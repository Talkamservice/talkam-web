...
export const CategoryTrending = () => {
    ...
    const handleScroll = useCallback((event) => {
        ...
        Storage.setItem("scrollPosition_categorytrending", scrollTop);
    }, [isFetching, trending]);

    const restoreScrollPosition = () => {
        const savedScrollPosition = Storage.getItem("scrollPosition_categorytrending");
