...
export const ProfileUpvotes = () => {
    ...
    return (
        <main className="flex h-full px-2 md:px-6">
            <section
            ...
            >
                {
                    isLoading ?
                        ...
                        newResults?.length > 0 ?
                            ...
                            :
                            !isLoading && !isFetching && userUpvotes.data.data.length === 0 ?
                                <section className="w-full py-1">
                                    <EmptyState
                                        icon={EmptyListIcon}
                                        height="h-[30px]"
                                        width="h-[30px]"
                                        text="No Post Upvotes"
                                        subtext="When upvotes are made they would appear here"
                                    />
                                </section>
                                :
                                null
