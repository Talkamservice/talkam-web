                    ...
                    <>
                        ...
                        </div>
                        {
                            ...
                            <section className="w-full p-2">
                                {
                                    messageController?.conversationdetails && !messageController?.messageFetching && !messageController?.detailsLoading && (Number(messageController?.currentUser?.id) !== Number(currentChat?.requested_by?.id)) && (messageController?.conversationdetails?.data?.status === "Awaiting_Response") ?
